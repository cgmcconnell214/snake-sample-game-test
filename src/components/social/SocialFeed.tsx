  ...
  if (!user) {
    return (
      <div className="text-center py-8">
        <p className="text-muted-foreground">Please sign in to view your social feed</p>
      </div>
    );
  }
        ...
        <Card key={post.id}>
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-medium">{post.user_profiles?.display_name}</p>
                  ...
                  <div key={comment.id} className="flex gap-2">
                    ...
                    <div className="flex-1">
                      <div className="bg-muted rounded-lg p-3">
                        <p className="text-sm font-medium">{comment.user_profiles?.display_name}</p>
