...
export default function CourseCreator(): JSX.Element {
  ...
  useEffect(() => {
    ...
    if (metaDesc)
      metaDesc.setAttribute(
        "content",
        "Manage your courses and enrollment links.",
      );
  }, []);
  ...
  const createLink = async () => {
    ...
    toast({
      title: "Link Created",
      description: "Share the link code with selected users.",
    });
    setMaxUses(10);
    setExpiresAt("");
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage courses, edit details, and generate enrollment links.
          </p>
        </div>
      </div>
        ...
        <div className="lg:col-span-2 space-y-4">
            ...
            <Card key={c.id}>
              ...
              <CardContent className="flex flex-wrap gap-2">
                ...
                <Button variant="secondary" asChild>
                  <a href={`/app/learning/courses/${c.slug ?? c.id}`}>
                    View Page
                  </a>
                </Button>
                <Button
          ...
          {myCourses.length === 0 && (
            <div className="text-muted-foreground">
              You haven’t created any courses yet. Go to Courses to create one.
            </div>
          )}
        </div>
              ...
              {links.map((l) => (
                ...
                >
                  ...
                  <div className="flex gap-2">
                    <Button variant="outline" onClick={() => copyLink(l.code)}>
