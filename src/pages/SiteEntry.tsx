...
import { AlertTriangle, Shield, UserCheck, Phone, FileText } from "lucide-react"
  ...
  const handleTermsAcceptance = () => {
    if (!acceptedTerms || !acceptedLiability) {
      toast({
        ...
        description: "You must accept both terms and liability waiver to continue.",
        variant: "destructive",
      })
      return
    }
              ...
              <div className="bg-muted/50 p-4 rounded-lg space-y-4">
                <div className="flex items-start space-x-2">
                  ...
                  <div className="grid gap-1.5 leading-none">
                    ...
                    <p className="text-xs text-muted-foreground">
                      I agree to the platform's Terms of Service, Privacy Policy, and understand that this platform deals with tokenized assets and blockchain technology. I acknowledge all associated risks.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => setAcceptedLiability(checked === true)}
                  />
                  <div className="grid gap-1.5 leading-none">
                    ...
                    <p className="text-xs text-muted-foreground">
                      I acknowledge that trading tokenized assets involves significant risk and I may lose my entire investment. I waive all claims against the platform and agree to indemnify the platform against losses.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="text-xs">
                    ...
                    <div className="text-muted-foreground">
                      This platform operates under strict compliance with financial regulations. 
                      All activities are monitored and logged for regulatory compliance.
                    </div>
                  </div>
                </div>
              </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="text-xs text-muted-foreground space-y-1">
                <p><strong>Device ID:</strong> {deviceFingerprint}</p>
                <p>This device will be linked to your account for security purposes.</p>
              </div>
