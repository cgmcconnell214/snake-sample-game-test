  ...
  const handleCreateTestingAgent = async () => {
    ...
    try {
      ...
      const testingAgentData = {
        ...
        description:
          "Comprehensive agent that tests all major functionality across the app including trading, IP tokenization, learning portal, live classes, and workflow automation.",
        category: "analytics",
        agent_type: "workflow",
        price_per_use: 0,
          ...
          steps: [
            ...
            },
            {
              ...
              config: {
                ...
                description:
                  "Tests order placement, market data retrieval, and portfolio management",
              },
            },
            {
              ...
              config: {
                ...
                description:
                  "Tests asset creation, token issuance, and staking functionality",
              },
            },
            {
              id: "test-learning",
              ...
              config: {
                ...
                description:
                  "Tests course creation, enrollment, and progress tracking",
              },
            },
            {
              id: "test-classes",
              ...
              config: {
                ...
                description:
                  "Tests class scheduling, registration, and session management",
              },
            },
            {
              id: "test-escrow",
              ...
              config: {
                ...
                description:
                  "Tests vault creation, locking, and unlock conditions",
              },
            },
            {
              id: "test-compliance",
              ...
              config: {
                ...
                description:
                  "Tests KYC verification, monitoring, and alert systems",
              },
            },
            {
              ...
              config: {
                ...
                description:
                  "Sends notification with comprehensive test results",
              },
            },
            {
              id: "generate-report",
              ...
              config: {
                ...
                format: "json",
                description:
                  "Compiles all test results into a comprehensive report",
              },
            },
          ],
          triggers: ["manual"],
      ...
      toast({
        ...
        description:
          "Site Functionality Tester has been created and is ready for deployment.",
      });
    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      {showComprehensiveTest ? (
        <ComprehensiveTestDashboard
          onClose={() => setShowComprehensiveTest(false)}
        />
      ) : showAnalytics ? (
            ...
            <div className="flex gap-2">
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="z-50 w-56">
                  ...
                  <DropdownMenuItem
                    onClick={handleCreateTestingAgent}
                    disabled={isLoading}
                  >
                      ...
                      {isUserAgent(agent) && (
                        <DropdownMenu>
                          ...
                          >
                            ...
                            <DropdownMenuItem
                              onClick={() => setWorkflowAgent(agent)}
                            >
                              <Code className="h-4 w-4 mr-2" />
                              Edit Workflow
                            </DropdownMenuItem>
                            <DropdownMenuItem
                              onClick={() => setDeploymentAgent(agent)}
                            >
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-medium">
                        {(
                          agent.total_tokens - agent.tokens_sold
                        ).toLocaleString()}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-2">
                    <Button
                      ...
                      disabled={
                        agent.total_tokens - agent.tokens_sold < 1000 ||
                        isLoading
                      }
                    >
                      {isLoading ? (
          ...
          <Dialog open={isCreateModalOpen} onOpenChange={setIsCreateModalOpen}>
            <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
              <DialogHeader>
                ...
                <p className="text-sm text-muted-foreground">
                  Fill in details for the new AI agent.
                </p>
              </DialogHeader>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="data_processor">
                          Data Processor
                        </SelectItem>
                        <SelectItem value="api_connector">
                          API Connector
                        </SelectItem>
                      </SelectContent>
                    </Select>
          ...
          >
            <DialogContent className="max-w-md">
              <DialogHeader>
                ...
                <p className="text-sm text-muted-foreground">
                  Update the properties for this agent.
                </p>
              </DialogHeader>
              {editingAgent && (
                <div className="space-y-4">
