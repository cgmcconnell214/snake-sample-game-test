      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
            {/* Free Tier */}
            <Card className={profile?.subscription_tier === 'free' ? 'ring-2 ring-primary' : ''}>
            ...
            {/* Standard Tier */}
            <Card className={profile?.subscription_tier === 'standard' ? 'ring-2 ring-primary' : ''}>
              <CardHeader className="pb-2">
            ...
            {/* Enterprise Tier */}
            <Card className={profile?.subscription_tier === 'enterprise' ? 'ring-2 ring-primary' : ''}>
              <CardHeader className="pb-2">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <Badge variant={profile?.compliance_risk === 'low' ? 'default' : 'destructive'}>
